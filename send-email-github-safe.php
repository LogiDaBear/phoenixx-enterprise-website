<?php
/**
 * EMAIL HANDLER - SAFE FOR GITHUB
 * This version uses environment variables instead of hardcoded passwords
 * 
 * SETUP: Create a .env file on your server (NOT in Git) with:
...
define('SMTP_PASSWORD', getenv('SMTP_PASSWORD') ?: 'YOUR_PASSWORD_HERE'); // Will use env var if available
